...
VERSION=$(cat fbreader/app/VERSION)

NAME="${APP}_${GIT_BRANCH}_${VERSION}_${DATE_START}"
echo "FYI, VERSION=$VERSION, GIT_BRANCH=$GIT_BRANCH at date: $DATE_START (approx: `date`)" | tee ${NAME}.log
